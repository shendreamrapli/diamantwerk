...
CREATE TABLE Version(
	...
	REFERENCES Vendor (VendID),	-- 'VendorID' Specifies where the FK comes FROM, (VendorID) is what it is called in other table
);
...
CREATE TABLE PrinterInfo(
	...
	PrinterInfo_InfoID int NULL,	--	Create the FK like other indexes From "Printer_Computers_Informations" Table
	...
	PrinterInfo_Model_ID int NULL,	--	Create the FK like other indexes From "dbo.Status" Table
