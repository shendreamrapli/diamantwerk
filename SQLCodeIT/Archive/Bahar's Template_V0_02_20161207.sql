...
-- ********************** Creat the table GeneralInformation *********************************
...
--Copy information of the printer from PrinterAbrasives
Insert into dbo.GeneralInformation (SerialNumber,IPAddress,MACAddress,Address,SystemName, )
SELECT Serialnumber,IPAddress,MACAddress,Address,Systemname
From dbo.PrinterAbrasives

--Insert into dbo.GeneralInformation (Model_ID)
--values (12)
--SELECT Model_ID FROM GeneralInformation
--WHERE Model_ID is NULL
--INSERT INTO GeneralInformation
--Values (12)
--WHERE Model_ID is NULL
SELECT GeneralInformation.Model_ID ISNULL(Model_ID, 12) 

select * from GeneralInformation 
select * from dbo.Product_Names
